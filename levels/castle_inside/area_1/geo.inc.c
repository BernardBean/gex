...
const GeoLayout castle_inside_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, -326, 0, castle_inside_dl_Cube_mesh_layer_1),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 712, -14, -561),
		GEO_OPEN_NODE(),
			GEO_SCENE_LIGHT(2, 128, 255, 0, 10, 10, 8),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
